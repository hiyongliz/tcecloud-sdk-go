...
type DescribeServiceTopologyResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		Edges []*MeshEdgeOut `json:"Edges,omitempty" name:"Edges"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type DescribeParamListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		AlertTkeAggPeriods []*ParamOut `json:"AlertTkeAggPeriods,omitempty" name:"AlertTkeAggPeriods"`
		// 告警等级

		AlertLevels []*ParamOut `json:"AlertLevels,omitempty" name:"AlertLevels"`
		// 告警恢复状态

		AmpRecoverStatus []*ParamOut `json:"AmpRecoverStatus,omitempty" name:"AmpRecoverStatus"`
		// 告警发送状态

		AmpSendStatus []*ParamOut `json:"AmpSendStatus,omitempty" name:"AmpSendStatus"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type DescribeTkeAlertMetricListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		TkeAlertMetrics []*TkeAlertMetricOut `json:"TkeAlertMetrics,omitempty" name:"TkeAlertMetrics"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type DescribeTkeClusterListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		Clusters []*TkeClusterOut `json:"Clusters,omitempty" name:"Clusters"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
