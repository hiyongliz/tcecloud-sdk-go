...
type GetMonitorDataRequest struct {
	*tchttp.BaseRequest
	...
	AppIdC *string `json:"AppIdC,omitempty" name:"AppIdC"`
	// 自定义Region

	RegionC *string `json:"RegionC,omitempty" name:"RegionC"`
	// 自定义Uin

	UinC *string `json:"UinC,omitempty" name:"UinC"`
	// 自定义SubAccountUin

	SubAccountUinC *string `json:"SubAccountUinC,omitempty" name:"SubAccountUinC"`
}
