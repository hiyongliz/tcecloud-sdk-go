...
func NewGetManageAccountAttributesRequest() (request *GetManageAccountAttributesRequest) {
	request = &GetManageAccountAttributesRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("account", APIVersion, "GetManageAccountAttributes")
	return
}

func NewGetManageAccountAttributesResponse() (response *GetManageAccountAttributesResponse) {
	response = &GetManageAccountAttributesResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 获取全量管控端账号扩展属性
func (c *Client) GetManageAccountAttributes(request *GetManageAccountAttributesRequest) (response *GetManageAccountAttributesResponse, err error) {
	if request == nil {
		request = NewGetManageAccountAttributesRequest()
	}
	response = NewGetManageAccountAttributesResponse()
	err = c.Send(request, response)
	return
}
...
func NewAddAttributeNameRequest() (request *AddAttributeNameRequest) {
	request = &AddAttributeNameRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("account", APIVersion, "AddAttributeName")
	return
}

func NewAddAttributeNameResponse() (response *AddAttributeNameResponse) {
	response = &AddAttributeNameResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 添加扩展属性
func (c *Client) AddAttributeName(request *AddAttributeNameRequest) (response *AddAttributeNameResponse, err error) {
	if request == nil {
		request = NewAddAttributeNameRequest()
	}
	response = NewAddAttributeNameResponse()
	err = c.Send(request, response)
	return
}
