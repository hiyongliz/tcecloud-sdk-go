...
func NewAllBizTopoIncludeResourcePoolRequest() (request *AllBizTopoIncludeResourcePoolRequest) {
	request = &AllBizTopoIncludeResourcePoolRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("opbiz", APIVersion, "AllBizTopoIncludeResourcePool")
	return
}

func NewAllBizTopoIncludeResourcePoolResponse() (response *AllBizTopoIncludeResourcePoolResponse) {
	response = &AllBizTopoIncludeResourcePoolResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 获取所有的业务树(含业务资源池)
func (c *Client) AllBizTopoIncludeResourcePool(request *AllBizTopoIncludeResourcePoolRequest) (response *AllBizTopoIncludeResourcePoolResponse, err error) {
	if request == nil {
		request = NewAllBizTopoIncludeResourcePoolRequest()
	}
	response = NewAllBizTopoIncludeResourcePoolResponse()
	err = c.Send(request, response)
	return
}
