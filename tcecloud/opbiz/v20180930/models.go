...
type AllBizTopoIncludeResourcePoolResponse struct {
	*tchttp.BaseResponse
...
func (r *AllBizTopoIncludeResourcePoolResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *AllBizTopoIncludeResourcePoolResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type RunStandardizationTaskRequest struct {
	*tchttp.BaseRequest
	...
	UuidLevelList []*UuidLevel `json:"UuidLevelList,omitempty" name:"UuidLevelList"`
...
type WorkflowPkg struct {
	...
	PkgInfoList []*PkgInfo `json:"PkgInfoList,omitempty" name:"PkgInfoList"`
}
...
type RunModuleWorkflowRequest struct {
	*tchttp.BaseRequest
	...
	Files []*PkgFile `json:"Files,omitempty" name:"Files"`
	// 操作名
...
type AllBizTopoIncludeResourcePoolRequest struct {
	*tchttp.BaseRequest
}

func (r *AllBizTopoIncludeResourcePoolRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *AllBizTopoIncludeResourcePoolRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type UnbindPkgRequest struct {
	*tchttp.BaseRequest
	...
	PkgInfo []*PkgInfo `json:"PkgInfo,omitempty" name:"PkgInfo"`
}
