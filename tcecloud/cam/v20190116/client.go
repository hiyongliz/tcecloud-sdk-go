...
func NewGetLoginDurationRequest() (request *GetLoginDurationRequest) {
	request = &GetLoginDurationRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("cam", APIVersion, "GetLoginDuration")
	return
}

func NewGetLoginDurationResponse() (response *GetLoginDurationResponse) {
	response = &GetLoginDurationResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 获取当前登陆态持续时间
func (c *Client) GetLoginDuration(request *GetLoginDurationRequest) (response *GetLoginDurationResponse, err error) {
	if request == nil {
		request = NewGetLoginDurationRequest()
	}
	response = NewGetLoginDurationResponse()
	err = c.Send(request, response)
	return
}
...
func NewGetLoginStrategyRequest() (request *GetLoginStrategyRequest) {
	request = &GetLoginStrategyRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("cam", APIVersion, "GetLoginStrategy")
	return
}

func NewGetLoginStrategyResponse() (response *GetLoginStrategyResponse) {
	response = &GetLoginStrategyResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 获取登录策略
func (c *Client) GetLoginStrategy(request *GetLoginStrategyRequest) (response *GetLoginStrategyResponse, err error) {
	if request == nil {
		request = NewGetLoginStrategyRequest()
	}
	response = NewGetLoginStrategyResponse()
	err = c.Send(request, response)
	return
}
...
func NewSetLoginStrategyRequest() (request *SetLoginStrategyRequest) {
	request = &SetLoginStrategyRequest{
		BaseRequest: &tchttp.BaseRequest{},
	}
	request.Init().WithApiInfo("cam", APIVersion, "SetLoginStrategy")
	return
}

func NewSetLoginStrategyResponse() (response *SetLoginStrategyResponse) {
	response = &SetLoginStrategyResponse{
		BaseResponse: &tchttp.BaseResponse{},
	}
	return
}
...
// 设置登录策略
func (c *Client) SetLoginStrategy(request *SetLoginStrategyRequest) (response *SetLoginStrategyResponse, err error) {
	if request == nil {
		request = NewSetLoginStrategyRequest()
	}
	response = NewSetLoginStrategyResponse()
	err = c.Send(request, response)
	return
}
...
func NewModifyNicknameRequest() (request *ModifyNicknameRequest) {
	...
	request.Init().WithApiInfo("cam", APIVersion, "ModifyNickname")
	return
}
