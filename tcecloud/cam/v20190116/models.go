...
type RoleInfo struct {
	...
	DeletionTaskId *uint64 `json:"DeletionTaskId,omitempty" name:"DeletionTaskId"`
	// 角色类型
...
type UserAttributeAndValue struct {
	// 属性名称
...
type PermType struct {
	...
	OpName *string `json:"OpName,omitempty" name:"OpName"`
	// 应用ID
	...
	AddTimestamp *int64 `json:"AddTimestamp,omitempty" name:"AddTimestamp"`
}
...
type LoginStrategyPeriod struct {
	// 开始时间，h:m:s
...
type GetLoginStrategyRequest struct {
	*tchttp.BaseRequest
...
func (r *GetLoginStrategyRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *GetLoginStrategyRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type GetServicePermListResponse struct {
	*tchttp.BaseResponse
	...
	Response *struct {
		...
		ProductShortName *ServicePermItem `json:"ProductShortName,omitempty" name:"ProductShortName"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}
...
type ListGroupsRequest struct {
	*tchttp.BaseRequest
	...
	FilterRemark *bool `json:"FilterRemark,omitempty" name:"FilterRemark"`
}
...
type ServicePermItem struct {
	...
	ReadWriteDetail *bool `json:"ReadWriteDetail,omitempty" name:"ReadWriteDetail"`
	// 资源类型
...
type LoginStrategy struct {
	...
	Open *int64 `json:"Open,omitempty" name:"Open"`
	// 模式，1-白名单，0-黑名单

	Mode *int64 `json:"Mode,omitempty" name:"Mode"`
	// 时间段

	Periods []*LoginStrategyPeriod `json:"Periods,omitempty" name:"Periods"`
}
...
type SetLoginStrategyResponse struct {
	*tchttp.BaseResponse
...
func (r *SetLoginStrategyResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *SetLoginStrategyResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type SubAccountFilter struct {
	...
	PermType []*PermType `json:"PermType,omitempty" name:"PermType"`
	// 企业微信用户Id
	...
	UserAttributeAndValues []*UserAttributeAndValue `json:"UserAttributeAndValues,omitempty" name:"UserAttributeAndValues"`
}
...
type GetLoginDurationResponse struct {
	*tchttp.BaseResponse
...
func (r *GetLoginDurationResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *GetLoginDurationResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type GetLoginDurationRequest struct {
	*tchttp.BaseRequest
}

func (r *GetLoginDurationRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *GetLoginDurationRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type GetLoginStrategyResponse struct {
	*tchttp.BaseResponse

	Response *struct {
		// 登录策略

		LoginStrategy *LoginStrategy `json:"LoginStrategy,omitempty" name:"LoginStrategy"`
		// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
		RequestId *string `json:"RequestId,omitempty" name:"RequestId"`
	} `json:"Response"`
}

func (r *GetLoginStrategyResponse) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *GetLoginStrategyResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type SetLoginStrategyRequest struct {
	*tchttp.BaseRequest
...
func (r *SetLoginStrategyRequest) ToJsonString() string {
	b, _ := json.Marshal(r)
	return string(b)
}

func (r *SetLoginStrategyRequest) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type UserAttributeAndValueAlias struct {
	// 扩展属性名称
	...
	AttributeId *string `json:"AttributeId,omitempty" name:"AttributeId"`
	// 值ID

	ValueId *string `json:"ValueId,omitempty" name:"ValueId"`
	// 用户UIN
