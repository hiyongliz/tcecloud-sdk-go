...
import (
	...
	location "github.com/hiyongliz/tcecloud-sdk-go/tcecloud/location/v20191128"
)
...
func main() {
	...
	// location是产品，yunapi3是调用版本， cloud.sunhongs.com是主域名。
	cpf.HttpProfile.Endpoint = "location.yunapi3.cloud.sunhongs.com"
